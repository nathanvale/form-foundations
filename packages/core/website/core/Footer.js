      ...
      <footer className="nav-footer" id="footer">
        <section className="sitemap">
          ...
          <div>
            ...
            <a href={this.docUrl('api/form-foundations', this.props.language)}>
              API Reference
            </a>
          </div>
          <div>
            ...
            <a href="https://discordapp.com/channels/102860784329052160/380509513863921674">
              Project Chat
            </a>
            <a
          ...
          <div>
            ...
            <a href="https://github.com/nathanvale/form-foundations">GitHub</a>
            <a
              className="github-button"
              href={this.props.config.repoUrl}
              data-icon="octicon-star"
              data-count-href="/nathanvale/form-foundations/stargazers"
